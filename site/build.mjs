...
const JS = [
  ...
  'eventos.js',
  'tv.js',
  'analytics.js', 'analytics-core.js',
  // libs compartilhadas
  'suprema-motion.js', 'suprema-auth.js', 'suprema-shell.js', 'suprema-palette.js', 'suprema-copiloto.js', 'suprema-db.js', 'suprema-feltro.js',
...
const CSS = [
  ...
  'dashboard-mesa-cash.css', 'eventos.css', 'tv.css', 'analytics.css', 'suprema-tokens.css',
].filter(existsSync);
...
async function run() {
  ...
  const HTML = [
    ...
    'dashboard-mesa-cash.html', 'eventos.html', 'tv.html', 'analytics.html',
  ].filter(existsSync);
